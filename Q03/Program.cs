...
public class Program
{
    public static void Main()
    {
           ...
           float.TryParse(InputThree, out float resultThree))
        {
            ...
            Console.WriteLine($"中間數為：{MiddleNumber}");
        }
    ...
    static string FindMiddleNumber(float result, float resultTwo, float resultThree)
    {
        ...
        if (result > resultTwo && result < resultThree || result > resultThree && result < resultTwo)
        {
            number = value;
        }
        else if (resultTwo > resultThree && resultTwo < result || resultTwo > result && resultTwo < resultThree)
        {
            number = valueTwo;
        }
        ...
        else if (resultTwo == resultThree && resultTwo > result)
        {
            number = value;
        }
        else if (resultTwo == resultThree && resultTwo < result)
